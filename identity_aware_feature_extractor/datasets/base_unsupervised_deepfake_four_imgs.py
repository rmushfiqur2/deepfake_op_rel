...
class DatasetBaseUnsupervised_deepfake_four_images(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_raw_gen = loaded_data["raw_img_gen_pil_rgb"]
        ...
        feature_raw_gen = loaded_data["raw_gen_feature"]
        ...
        return image_raw, image_recons, image_double_recons, image_raw_gen, feature_raw, \
               feature_recons, feature_double_recons, feature_raw_gen
