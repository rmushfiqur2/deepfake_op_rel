...
gen_folder_path = base_path + 'face-celebdfv2-gan-using5-9'
term_to_remove = '-gan-using5-9'
save_path = '../data_deepfake/compact/'
...
for file_path in file_list:
    ...
    if os.path.isfile(file_path) and os.path.isfile(file_raw):
        ...
        new_dic = {"raw_img_pil_rgb": image_raw, "recons_img_pil_rgb":image_recons, "raw_feature":out1, "recons_feature":out2}
