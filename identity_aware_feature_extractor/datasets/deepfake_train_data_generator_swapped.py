...
swap_folder_path = base_path + 'face-celebdfv2-gan-using1sthalf-swapped-using0-4' #D22
swap_gen_folder_path = base_path + 'face-celebdfv2-swapped-using0-4' #D3
orig_folder_path = base_path + 'face-celebdfv2' #D11

save_path = '../data_deepfake/compact-train-swapped/'
