...
if __name__ == '__main__':
    ...
    for R in range(4):  # repeat process
        ...
        for n in range(62):
            ...
            file = glob.glob(
                '../required-feature-folder-efficientnet//saved_features/features_real_' +
            ...
            for idx in train_index:
                file = glob.glob('../required-feature-folder-efficientnet//saved_features/' +
        ...
        net_tuned, train_loss_history, valid_loss_history = Tune_NN_baseline_efficientnet(
